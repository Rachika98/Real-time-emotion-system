...
%         Ism(:,:,3) = 125;
        ...
        title(cl{c3})
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
                % add your different condtion here in this area  change 
        if ( (c1 == 1) && (c2 == 1) &&  (c3== 1) )
            disp('surprised')    % this will print when this all condtion true
        end
    
         if ( (c1 == 1) && (c2 == 1) &&  (c3== 2) )
            disp('happy')   % this will print when this all condtion true
         end 
         if ( (c1 == 2) && (c2 == 2) &&  (c3== 2) )
            disp('fear')    % this will print when this all condtion true
        end
    
         if ( (c1 == 2) && (c2 == 2) &&  (c3== 1) )
            disp('scared')   % this will print when this all condtion true
        end 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
